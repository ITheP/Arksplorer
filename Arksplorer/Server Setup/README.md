...
You can find more information about ArkViewer at 
...
When the above is up and running, you should end up with...
    ...
    - When this happens, ArkViewer is run which generates .json files
...
and the data files above appear as...
...
3. Arksplorer server side configuration
...
4.2. Getting us to add your server information
...
We highly recommend you try the `do it yourself` version described in 4.1 first to make sure it works before passing the details on to us.

4.3 Arksplorer process overview
